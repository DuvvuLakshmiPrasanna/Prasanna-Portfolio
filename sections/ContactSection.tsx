              ...
              <div className="flex flex-wrap gap-2">
                {SOCIAL_LINKS.map((link) => (
                  <Link
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-card/70 px-4 py-2 text-sm font-medium text-foreground/95 transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-glow"
              ...
              <div className="flex h-full flex-col gap-6">
                <div>
                  ...
                  <p className="mt-3 text-sm text-foreground/90">
                    Fill this form and your message will be sent directly to my inbox.
                  </p>
                </div>
                ...
                <form className="grid gap-4" onSubmit={handleSubmit}>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <label className="grid gap-2">
                      ...
                      <input
                        ...
                        className="rounded-2xl border border-border/70 bg-background/55 px-4 py-3 text-sm text-foreground outline-none transition-colors focus:border-primary/40"
                  ...
                  <button
                    type="submit"
                    disabled={isSending}
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-primary to-secondary px-6 py-3 text-sm font-semibold text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-glow-lg disabled:cursor-not-allowed disabled:opacity-70"
                  >
                    <Send size={16} />
